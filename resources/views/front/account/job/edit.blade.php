        ...
        <section class="section-5 bg-2">
            <div class="container py-5">
                ...
                <div class="col-lg-9">
                    ...
                    @endif
                    <form action="{{ route('account.updateJob', $job->id) }}" method="post" class="needs-validation"
                        novalidate>
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" name="description" id="description" cols="5"
                                            rows="5" placeholder="Description" required> {{ $job->description }} </textarea>
                                        <div class="invalid-feedback" id="feedback">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea  class="form-control" name="benefits" id="benefits" cols="5"
                                            rows="5" placeholder="Benefits">{{ $job->benefits }}</textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label for="responsibility" class="mb-2">Responsibility</label>
                                        <textarea  class="form-control" name="responsibility" id="responsibility"
                                            cols="5" rows="5" placeholder="Responsibility">{{ $job->responsibility }}</textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label for="qualifications" class="mb-2">Qualifications</label>
                                        <textarea class="form-control" name="qualifications" id="qualifications"
                                            cols="5" rows="5" placeholder="Qualifications"> {{ $job->qualifications }}</textarea>
                                    </div>
